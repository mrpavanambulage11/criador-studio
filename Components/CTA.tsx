...
export default function CTA() {
  return (
    <section className="py-12 md:py-16 px-4 md:px-6">
      ...
      >
        {/* Background orbs */}
        <div className="absolute -top-20 -left-20 w-80 h-80 rounded-full bg-[#B5552A]/20 blur-3xl" />
        <div className="absolute -bottom-20 -right-20 w-80 h-80 rounded-full bg-[#B5552A]/10 blur-3xl" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_50%_0%,rgba(181,85,42,0.15),transparent)]" />
        ...
        <div className="relative z-10 text-center">
          <motion.p
            ...
            className="uppercase tracking-[4px] text-[#B5552A] text-sm font-medium mb-6"
          >
            Let's Work Together
          </motion.p>
          ...
          >
            Your Next Brand Is
            <span className="block text-[#B5552A]">One Call Away.</span>
          </motion.h2>
          ...
          >
            <MagneticButton>
              <a
                href="#contact"
                className="inline-block px-10 py-5 bg-[#B5552A] hover:bg-[#9E4822] text-white rounded-full text-base font-semibold shadow-lg shadow-[#B5552A]/30 hover:shadow-[#B5552A]/50 transition-all duration-200 hover:scale-105 active:scale-95"
              >
